...
const Main = () => {
  ...
  // Function to handle featured filter
  const handleFeaturedFilter = (featured) => {
    // Toggle the featured filter
    if (activeFeatured.includes(featured)) {
      const updatedFeatured = activeFeatured.filter((f) => f !== featured);
      setActiveFeatured(updatedFeatured);
    } else {
      setActiveFeatured([...activeFeatured, featured]);
    }
  };
  const handleStyleFilter = (style) => {
    // Toggle the featured filter
    if (activeStyle.includes(style)) {
      const updatedStyle = activeStyle.filter((s) => s !== style);
      setActiveStyle(updatedStyle);
    } else {
      setActiveStyle([...activeStyle, style]);
    }
  };

  // Function to filter icons based on active categories and featured options
  const filterIcons = (icon) => {
    if (activeCategories.length === 0 && activeFeatured.length === 0 && activeStyle.length === 0) {
      // If no filters are selected, show all icons
      return true;
    }
    const matchesCategory = activeCategories.length === 0 || activeCategories.includes(icon.category);
    const matchesFeatured = activeFeatured.length === 0 || activeFeatured.includes(icon.featured);
    const matchesStyle = activeStyle.length === 0 || activeStyle.includes(icon.style);
    
    return matchesCategory && matchesFeatured && matchesStyle;
  };
  ...
  const selectedIcons = filteredIcons.filter((icon) => {
    return (
      filterIcons(icon) &&
      (icon.text.toLowerCase().includes(filter.toLowerCase()) || !filter)
    );
  });
  ...
  className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeStyle.includes("Solid") ? "text-white bg-blue-400" : ""
  }`}
  onClick={() => handleStyleFilter("Solid")}
>
  <label className="flex items-center mx-4 custom-label">
    ...
    <label
      htmlFor="category"
      className={`ml-2 text-gray-800 cursor-pointer text-xs ${
        activeStyle.includes("Solid") ? "text-white bg-blue-400" : ""
      }`}
    >
      Solid
    ...
    27
              ...
              <li
                className={`flex items-justify-center mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
                  activeStyle.includes("Regular")
                    ? "text-white bg-blue-400"
                    : ""
                }`}
                onClick={() => handleStyleFilter("Regular")}
              >
            ...
            <li
  className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeFeatured.includes("New")
      ? "text-white bg-blue-400"
      : ""
  }`}
  onClick={() => handleFeaturedFilter("New")}
>
  <label className="flex items-center mx-4 custom-label">
    <input
      type="radio"
      className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      name="category"
      checked={activeFeatured.includes("New")}
      onChange={() => handleFeaturedFilter("New")}
    />
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
    ...
    <label // Added label for the text
      htmlFor="category"
      className={`ml-2 text-gray-800 cursor-pointer text-xs ${
        activeFeatured.includes("New")
          ? "text-white bg-blue-400"
...
<li
  className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeFeatured.includes("Sponsored")
      ? "text-white bg-blue-400"
      : ""
  }`}
  onClick={() => handleFeaturedFilter("Sponsored")}
>
  <label className="flex items-center mx-4 custom-label">
    <input
      type="radio"
      className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      name="category"
      checked={activeFeatured.includes("Sponsored")}
      onChange={() => handleFeaturedFilter("Sponsored")}
    />
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
    ...
    >
      <path
        d="M160 0c17.7 0 32 14.3 32 32V67.7c1.6 .2 3.1 .4 4.7 .7c.4 .1 .7 .1 1.1 .2l48 8.8c17.4 3.2 28.9 19.9 25.7 37.2s-19.9 28.9-37.2 25.7l-47.5-8.7c-31.3-4.6-58.9-1.5-78.3 6.2s-27.2 18.3-29.0 28.1c-2.0 10.7-.5 16.7 1.2 20.4c1.8 3.9 5.5 8.3 12.8 13.2c16.3 10.7 41.3 17.7 73.7 26.3l2.9 .8c28.6 7.6 63.6 16.8 89.6 33.8c14.2 9.3 27.6 21.9 35.9 39.5c8.5 17.9 10.3 37.9 6.4 59.2c-6.9 38-33.1 63.4-65.6 76.7c-13.7 5.6-28.6 9.2-44.4 11V480c0 17.7-14.3 32-32 32s-32-14.3-32-32V445.1c-.4-.1-.9-.1-1.3-.2l-.2 0 0 0c-24.4-3.8-64.5-14.3-91.5-26.3c-16.1-7.2-23.4-26.1-16.2-42.2s26.1-23.4 42.2-16.2c20.9 9.3 55.3 18.5 75.2 21.6c31.9 4.7 58.2 2.0 76.0-5.3c16.9-6.9 24.6-16.9 26.8-28.9c1.9-10.6 .4-16.7-1.3-20.4c-1.9-4-5.6-8.4-13.0-13.3c-16.4-10.7-41.5-17.7-74.0-26.3l-2.8-.7 0 0C119.4 279.3 84.4 270.0 58.4 253c-14.2-9.3-27.5-22.0-35.8-39.6c-8.4-17.9-10.1-37.9-6.1-59.2C23.7 116.0 52.3 91.2 84.8 78.3c13.3-5.3 27.9-8.9 43.2-11V32c0-17.7 14.3-32 32-32z"
        fill="#616D8A"
      />
    </svg>
    <label // Added label for the text
...
<li
  className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeFeatured.includes("Staff")
      ? "text-white bg-blue-400"
      : ""
  }`}
  onClick={() => handleFeaturedFilter("Staff")}
>
  <label className="flex items-center mx-4 custom-label">
    <input
      type="radio"
      className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      name="category"
      checked={activeFeatured.includes("Staff")}
      onChange={() => handleFeaturedFilter("Staff")}
    />
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
...
>
  <label className="flex items-center mx-4 custom-label">
    <input
      ...
      className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      name="category"
      checked={activeCategories.includes("animals")}
      onChange={() => handleCategoryFilter("animals")}
    />
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
...
>
  <label className="flex items-center mx-4 custom-label">
    <input
      ...
      className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      name="category"
      checked={activeCategories.includes("Buildings")}
      onChange={() => handleCategoryFilter("Buildings")}
    />
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
...
>
  <label className="flex items-center mx-4 custom-label">
    <input
      ...
      className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      name="category"
      checked={activeCategories.includes("Business")}
      onChange={() => handleCategoryFilter("Business")}
    />
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
...
>
  <label className="flex items-center mx-4 custom-label">
    <input
      ...
      className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      name="category"
      checked={activeCategories.includes("Camping")}
      onChange={() => handleCategoryFilter("Camping")}
    />
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
...
>
  <label className="flex items-center mx-4 custom-label">
    <input
      ...
      className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      name="category"
      checked={activeCategories.includes("Energy")}
      onChange={() => handleCategoryFilter("Energy")}
    />
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
...
>
  <label className="flex items-center mx-4 custom-label">
    <input
      ...
      className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      name="category"
      checked={activeCategories.includes("Emoji")}
      onChange={() => handleCategoryFilter("Emoji")}
    />
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
...
>
  <label className="flex items-center mx-4 custom-label">
    <input
      ...
      className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      name="category"
      checked={activeCategories.includes("Socials")}
      onChange={() => handleCategoryFilter("Socials")}
    />
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
    ...
    >
      <path
        d="M181.3 32.4c17.4 2.9 29.2 19.4 26.3 36.8L197.8 128h95.1l11.5-69.3c2.9-17.4 19.4-29.2 36.8-26.3s29.2 19.4 26.3 36.8L357.8 128H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H347.1L325.8 320H384c17.7 0 32 14.3 32 32s-14.3 32-32 32H315.1l-11.5 69.3c-2.9 17.4-19.4 29.2-36.8 26.3s-29.2-19.4-26.3-36.8l9.8-58.7H155.1l-11.5 69.3c-2.9 17.4-19.4 29.2-36.8 26.3zM187.1 192L165.8 320h95.1l21.3-128H187.1z"
        fill="#616D8A"
      />
    </svg>
    <label // Added label for the text
...
>
  <label className="flex items-center mx-4 custom-label">
    <input
      ...
      className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      name="category"
      checked={activeCategories.includes("Music")}
...
>
  <label className="flex items-center mx-4 custom-label">
    <input
      ...
      className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      name="category"
      checked={activeCategories.includes("Text")}
      onChange={() => handleCategoryFilter("Text")}
    />
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
