...
const Main = () => {
  const [activeCategory, setActiveCategory] = useState([]);
    ...
    const handleCategoryFilter = (category) => {
      ...
      const filtered = iconsData.filter((icon) => icon.category === category);
...
<>
<Csbf sendDataToParent={dataFromChild} setIconSize={setIconSize} setIconSize1={toggleIconSize} />
  ...
  {/* Categories */}
  <h2 className="text-xs uppercase text-gray-500 font-semibold tracking-wide mt-12 p-2">Style</h2>

  <ul>
  <li  className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeCategory === 'solid' ? 'text-white bg-blue-400 ' : ''}`} onClick={() => handleCategoryFilter('solid')}>
    <label className="flex items-center mx-4 custom-label">
      <input
        ...
        name="category"
      />
      <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" style={{ pointerEvents: 'none', visibility: 'visible' }}><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512z" fill="#616D8A" />
      </svg>
      <span className={`ml-2 text-gray-800 text-xs ${
    activeCategory === 'solid' ? 'text-white ' : ''}`}>Solid</span>
    </label>
    <span className={`text-gray-800 text-xs ${
    activeCategory === 'solid' ? 'text-white ' : ''}`}>27</span>
  </li>
  <li className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeCategory === 'regular' ? 'bg-blue-400 text-white' : ''
  }`} onClick={() => handleCategoryFilter('regular')}>
    <div className="flex items-center mx-4">
      <input type="radio" className="form-radio custom-radio h-6 w-6  square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300" />
      <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" className=''><path d="M448 256c0-106-86-192-192-192V448c106 0 192-86 192-192zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256z" fill="#616D8A" /></svg>
      <span className={`ml-2 text-gray-800 text-xs ${
    activeCategory === 'regular' ? 'text-white ' : ''}`}>Regular</span>
    </div>
    <span className={`text-gray-800 text-xs ${
    activeCategory === 'regular' ? 'text-white ' : ''}`}>4</span>
  </li>
 
</ul>
{/* Featured */}
<h2 className="text-xs uppercase text-gray-500 font-semibold tracking-wide mt-12 p-2">Featured</h2>

  <ul>
  <li className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeCategory === 'New' ? 'text-white bg-blue-400 ' : ''}`} onClick={() => handleCategoryFilter('New')}>
    <label className="flex items-center mx-4 custom-label">
      <input
        type="radio"
        className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      ...
      <span className={`ml-2 text-gray-800 text-xs ${
    activeCategory === 'New' ? 'text-white ' : ''}`}>New In V6</span>
    </label>
    <span className={`text-gray-800 text-xs ${
    activeCategory === 'New' ? 'text-white ' : ''}`}>2</span>
  </li>
  <li className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeCategory === 'Sponsored' ? 'text-white bg-blue-400 ' : ''}`} onClick={() => handleCategoryFilter('Sponsored')}>
    <div className="flex items-center mx-4">
    <input
        type="radio"
        className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
        name="category"
      />
      <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 320 512" style={{ pointerEvents: 'none', visibility: 'visible' }}><path d="M160 0c17.7 0 32 14.3 32 32V67.7c1.6 .2 3.1 .4 4.7 .7c.4 .1 .7 .1 1.1 .2l48 8.8c17.4 3.2 28.9 19.9 25.7 37.2s-19.9 28.9-37.2 25.7l-47.5-8.7c-31.3-4.6-58.9-1.5-78.3 6.2s-27.2 18.3-29 28.1c-2 10.7-.5 16.7 1.2 20.4c1.8 3.9 5.5 8.3 12.8 13.2c16.3 10.7 41.3 17.7 73.7 26.3l2.9 .8c28.6 7.6 63.6 16.8 89.6 33.8c14.2 9.3 27.6 21.9 35.9 39.5c8.5 17.9 10.3 37.9 6.4 59.2c-6.9 38-33.1 63.4-65.6 76.7c-13.7 5.6-28.6 9.2-44.4 11V480c0 17.7-14.3 32-32 32s-32-14.3-32-32V445.1c-.4-.1-.9-.1-1.3-.2l-.2 0 0 0c-24.4-3.8-64.5-14.3-91.5-26.3c-16.1-7.2-23.4-26.1-16.2-42.2s26.1-23.4 42.2-16.2c20.9 9.3 55.3 18.5 75.2 21.6c31.9 4.7 58.2 2 76-5.3c16.9-6.9 24.6-16.9 26.8-28.9c1.9-10.6 .4-16.7-1.3-20.4c-1.9-4-5.6-8.4-13-13.3c-16.4-10.7-41.5-17.7-74-26.3l-2.8-.7 0 0C119.4 279.3 84.4 270 58.4 253c-14.2-9.3-27.5-22-35.8-39.6c-8.4-17.9-10.1-37.9-6.1-59.2C23.7 116 52.3 91.2 84.8 78.3c13.3-5.3 27.9-8.9 43.2-11V32c0-17.7 14.3-32 32-32z" fill="#616D8A"/></svg>
      <span className={`ml-2 text-gray-800 text-xs ${
    activeCategory === 'Sponsored' ? 'text-white' : ''}`}>Sponsored</span>
    </div>
    <span className={`text-gray-800 text-xs ${
    activeCategory === 'Sponsored' ? 'text-white' : ''}`}>7</span>
  </li>
  <li className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeCategory === 'Staff' ? 'text-white bg-blue-400 ' : ''}`} onClick={() => handleCategoryFilter('Staff')}>
    <div className="flex items-center mx-4">
    <input
        type="radio"
        className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
        name="category"
      />
      <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M47.6 300.4L228.3 469.1c7.5 7 17.4 10.9 27.7 10.9s20.2-3.9 27.7-10.9L464.4 300.4c30.4-28.3 47.6-68 47.6-109.5v-5.8c0-69.9-50.5-129.5-119.4-141C347 36.5 300.6 51.4 268 84L256 96 244 84c-32.6-32.6-79-47.5-124.6-39.9C50.5 55.6 0 115.2 0 185.1v5.8c0 41.5 17.2 81.2 47.6 109.5z" fill="#616D8A"/></svg>
      <span className={`ml-2 text-gray-800 text-xs ${
    activeCategory === 'Staff' ? 'text-white' : ''}`}>Staff Favorites</span>
    </div>
    <span className={`text-gray-800 text-xs ${
    activeCategory === 'Staff' ? 'text-white' : ''}`}>4</span>
  </li>
  {/* Add more categories as needed */}
</ul>
{/* Categories */}

<h2 className="text-xs uppercase text-gray-500 font-semibold tracking-wide mt-12 p-2">Categories</h2>

  <ul>
  <li className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeCategory === 'animals' ? ' bg-blue-400 ' : ''}`} onClick={() => handleCategoryFilter('animals')}>
    <label className="flex items-center mx-4 custom-label">
      <input
        type="radio"
        className="form-radio custom-radio h-7 w-7 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
        name="category"
      />
     <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"><path d="M320 192h17.1c22.1 38.3 63.5 64 110.9 64c11 0 21.8-1.4 32-4v4 32V480c0 17.7-14.3 32-32 32s-32-14.3-32-32V339.2L280 448h56c17.7 0 32 14.3 32 32s-14.3 32-32 32H192c-53 0-96-43-96-96V192.5c0-16.1-12-29.8-28-31.8l-7.9-1c-17.5-2.2-30-18.2-27.8-35.7s18.2-30 35.7-27.8l7.9 1c48 6 84.1 46.8 84.1 95.3v85.3c34.4-51.7 93.2-85.8 160-85.8zm160 26.5v0c-10 3.5-20.8 5.5-32 5.5c-28.4 0-54-12.4-71.6-32h0c-3.7-4.1-7-8.5-9.9-13.2C357.3 164 352 146.6 352 128v0V32 12 10.7C352 4.8 356.7 .1 362.6 0h.2c3.3 0 6.4 1.6 8.4 4.2l0 .1L384 21.3l27.2 36.3L416 64h64l4.8-6.4L512 21.3 524.8 4.3l0-.1c2-2.6 5.1-4.2 8.4-4.2h.2C539.3 .1 544 4.8 544 10.7V12 32v96c0 17.3-4.6 33.6-12.6 47.6c-11.3 19.8-29.6 35.2-51.4 42.9zM432 128a16 16 0 1 0 -32 0 16 16 0 1 0 32 0zm48 16a16 16 0 1 0 0-32 16 16 0 1 0 0 32z" fill="#616D8A"/></svg>
      ...
      <span className={`ml-2 text-gray-800 text-xs ${
    activeCategory === 'animals' ? 'text-white' : ''}`}>Amimals</span>
    </label>
    <span className={`text-gray-800 text-xs ${
    activeCategory === 'animals' ? 'text-white' : ''}`}>2</span>
  </li>
  <li className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeCategory === 'Building' ? 'text-white bg-blue-400 ' : ''}`} onClick={() => handleCategoryFilter('Building')}>
    <div className="flex items-center mx-4">
    <input
        type="radio"
        className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      ...
      <span className={`ml-2 text-gray-800 text-xs ${
    activeCategory === 'Building' ? 'text-white' : ''}`}>Buildings</span>
    </div>
    <span className={`text-gray-800 text-xs ${
    activeCategory === 'Building' ? 'text-white' : ''}`}>7</span>
  </li>
  <li className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeCategory === 'Business' ? 'text-white bg-blue-400 ' : ''}`} onClick={() => handleCategoryFilter('Business')}>
    <div className="flex items-center mx-4">
    <input
        type="radio"
        className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      ...
      <span className={`ml-2 text-gray-800 text-xs ${
    activeCategory === 'Business' ? 'text-white' : ''}`}>Business</span>
    </div>
    <span className={`text-gray-800 text-xs ${
    activeCategory === 'Business' ? 'text-white ' : ''}`}>4</span>
  </li>
  <li className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeCategory === 'Camping' ? 'text-white bg-blue-400 ' : ''}`} onClick={() => handleCategoryFilter('Camping')}>
    <label className="flex items-center mx-4 custom-label">
      <input
        type="radio"
        className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      ...
      <span className={`ml-2 text-gray-800 text-xs ${
    activeCategory === 'Camping' ? 'text-white' : ''}`}>Camping</span>
    </label>
    <span className={`text-gray-800 text-xs ${
    activeCategory === 'Camping' ? 'text-white ' : ''}`}>2</span>
  </li>
  <li className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeCategory === 'Energy' ? 'text-white bg-blue-400 ' : ''}`} onClick={() => handleCategoryFilter('Energy')}>
    <label className="flex items-center mx-4 custom-label">
      <input
        type="radio"
        className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      ...
      <span className={`ml-2 text-gray-800 text-xs ${
    activeCategory === 'Energy' ? 'text-white' : ''}`}>Energy</span>
    </label>
    <span className={`text-gray-800 text-xs ${
    activeCategory === 'Energy' ? 'text-white ' : ''}`}>2</span>
  </li>
  <li className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeCategory === 'Emoji' ? 'text-white bg-blue-400 ' : ''}`} onClick={() => handleCategoryFilter('Emoji')}>
    <label className="flex items-center mx-4 custom-label">
      <input
        type="radio"
        className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
     ...
     <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M464 256A208 208 0 1 0 48 256a208 208 0 1 0 416 0zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zm349.5 52.4c18.7-4.4 35.9 12 25.5 28.1C350.4 374.6 306.3 400 255.9 400s-94.5-25.4-119.1-63.5c-10.4-16.1 6.8-32.5 25.5-28.1c28.9 6.8 60.5 10.5 93.6 10.5s64.7-3.7 93.6-10.5zm-216-161.7l89.9 47.9c10.7 5.7 10.7 21.1 0 26.8l-89.9 47.9c-7.9 4.2-17.5-1.5-17.5-10.5c0-2.8 1-5.5 2.8-7.6l36-43.2-36-43.2c-1.8-2.1-2.8-4.8-2.8-7.6c0-9 9.6-14.7 17.5-10.5zM396 157.1c0 2.8-1 5.5-2.8 7.6l-36 43.2 36 43.2c1.8 2.1 2.8 4.8 2.8 7.6c0 9-9.6 14.7-17.5 10.5l-89.9-47.9c-10.7-5.7-10.7-21.1 0-26.8l89.9-47.9c7.9-4.2 17.5 1.5 17.5 10.5z" fill="#616D8A"/></svg>
      <span className={`ml-2 text-gray-800 text-xs ${
    activeCategory === 'Emoji' ? 'text-white' : ''}`}>Emoji</span>
    </label>
    <span className={`text-gray-800 text-xs ${
    activeCategory === 'Emoji' ? 'text-white ' : ''}`}>2</span>
  </li>
  <li className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeCategory === 'Socials' ? 'text-white bg-blue-400 ' : ''}`} onClick={() => handleCategoryFilter('Socials')}>
    <label className="flex items-center mx-4 custom-label">
      <input
        type="radio"
        className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      ...
      <span className={`ml-2 text-gray-800 text-xs  ${
    activeCategory === 'Socials' ? 'text-white ' : ''}`}>Socials</span>
    </label>
    <span className={`text-gray-800 text-xs  ${
    activeCategory === 'Socials' ? 'text-white ' : ''}`}>12</span>
  </li>
  <li className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeCategory === 'Music' ? 'text-white bg-blue-400 ' : ''}`} onClick={() => handleCategoryFilter('Music')}>
    <label className="flex items-center mx-4 custom-label">
      <input
        type="radio"
        className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
      ...
      <span className={`ml-2 text-gray-800 text-xs ${
    activeCategory === 'Music' ? 'text-white' : ''}`}>Music</span>
    </label>
    <span className={`text-gray-800 text-xs ${
    activeCategory === 'Music' ? 'text-white ' : ''}`}>8</span>
  </li>
  <li className={`flex items-center justify-between mb-2 cursor-pointer rounded p-2 hover:border hover:border-gray-400 hover:rounded-lg ${
    activeCategory === 'Text' ? 'text-white bg-blue-400 ' : ''}`} onClick={() => handleCategoryFilter('Text')}>
    <label className="flex items-center mx-4 custom-label">
      <input
        type="radio"
        className="form-radio custom-radio h-6 w-6 square-radio absolute opacity-0 hover:opacity-100 hover:visible transition-opacity duration-300"
        name="category"
        style={{ backgroundColor: activeCategory === 'Text' ? 'white' : '' }} // Add this line
      />
      ...
      <span className={`ml-2 text-gray-800 text-xs  ${
    activeCategory === 'Text' ? 'text-white' : ''}`}>Text</span>
    </label>
    <span className={`text-gray-800 text-xs  ${
    activeCategory === 'Text' ? 'text-white' : ''}`}>2</span>
</li>
